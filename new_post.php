          ...
          <div class="editor-grid">
            ...
            <aside class="min-w-0">
              <div class="border border-[#d6d6d6] bg-[#fafafa] p-3.5 rounded-xs">
                ...
                <div class="border-2 border-dashed border-[#d5d5d5] rounded-[3px] py-4.5 px-3 text-center text-[#777] text-[13px] bg-white cursor-pointer" id="dropzone">
                  Arrastra aquí las imágenes
                </div>
                <div class="grid grid-cols-[repeat(auto-fill,minmax(88px,1fr))] gap-2.5 mt-3" id="imageGallery"></div>
              </div>
            </aside>
          </div>
        </section>
